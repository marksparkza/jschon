...
from jschon.vocabulary import Metaschema, Vocabulary
from tests import (
    metaschema_uri_2020_12,
    core_vocab_uri_2020_12, core_vocab_uri_next,
)
...
def test_default_core(catalog):
    ...
    core = Vocabulary.get(core_vocab_uri_2020_12)
    m = Metaschema(
        catalog,
        metaschema_data,
        core,
