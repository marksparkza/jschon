...
def initialize():
    ...
    Catalogue.create_vocabulary(
        ...
        KeywordDef(ThenKeyword, "then",
                   depends_on=("if",),
                   ),
        KeywordDef(ElseKeyword, "else",
                   depends_on=("if",),
                   ),
        KeywordDef(DependentSchemasKeyword, "dependentSchemas",
                   instance_types=("object",),
                   ),
        KeywordDef(ItemsKeyword, "items",
                   instance_types=("array",),
                   ),
        KeywordDef(AdditionalItemsKeyword, "additionalItems",
                   depends_on=("items",),
                   instance_types=("array",),
                   ),
        KeywordDef(UnevaluatedItemsKeyword, "unevaluatedItems",
                   depends_on=("items", "additionalItems", "if", "then", "else",
                               "allOf", "anyOf", "oneOf", "not",),
                   instance_types=("array",),
                   ),
        KeywordDef(ContainsKeyword, "contains",
                   instance_types=("array",),
                   ),
        KeywordDef(PropertiesKeyword, "properties",
                   instance_types=("object",),
                   ),
        KeywordDef(PatternPropertiesKeyword, "patternProperties",
                   instance_types=("object",),
                   ),
        KeywordDef(AdditionalPropertiesKeyword, "additionalProperties",
                   depends_on=("properties", "patternProperties",),
                   instance_types=("object",),
                   ),
        KeywordDef(UnevaluatedPropertiesKeyword, "unevaluatedProperties",
                   depends_on=("properties", "patternProperties", "additionalProperties",
                               "if", "then", "else", "dependentSchemas",
                               "allOf", "anyOf", "oneOf", "not",),
                   instance_types=("object",),
                   ),
        KeywordDef(PropertyNamesKeyword, "propertyNames",
                   instance_types=("object",),
                   ),
    )
    ...
    Catalogue.create_vocabulary(
        ...
        KeywordDef(MultipleOfKeyword, "multipleOf",
                   instance_types=("number",),
                   ),
        KeywordDef(MaximumKeyword, "maximum",
                   instance_types=("number",),
                   ),
        KeywordDef(ExclusiveMaximumKeyword, "exclusiveMaximum",
                   instance_types=("number",),
                   ),
        KeywordDef(MinimumKeyword, "minimum",
                   instance_types=("number",),
                   ),
        KeywordDef(ExclusiveMinimumKeyword, "exclusiveMinimum",
                   instance_types=("number",),
                   ),
        KeywordDef(MaxLengthKeyword, "maxLength",
                   instance_types=("string",),
                   ),
        KeywordDef(MinLengthKeyword, "minLength",
                   instance_types=("string",),
                   ),
        KeywordDef(PatternKeyword, "pattern",
                   instance_types=("string",),
                   ),
        KeywordDef(MaxItemsKeyword, "maxItems",
                   instance_types=("array",),
                   ),
        KeywordDef(MinItemsKeyword, "minItems",
                   instance_types=("array",),
                   ),
        KeywordDef(UniqueItemsKeyword, "uniqueItems",
                   instance_types=("array",),
                   ),
        KeywordDef(MaxContainsKeyword, "maxContains",
                   depends_on=("contains",),
                   instance_types=("array",),
                   ),
        KeywordDef(MinContainsKeyword, "minContains",
                   depends_on=("contains", "maxContains",),
                   instance_types=("array",),
                   ),
        KeywordDef(MaxPropertiesKeyword, "maxProperties",
                   instance_types=("object",),
                   ),
        KeywordDef(MinPropertiesKeyword, "minProperties",
                   instance_types=("object",),
                   ),
        KeywordDef(RequiredKeyword, "required",
                   instance_types=("object",),
                   ),
        KeywordDef(DependentRequiredKeyword, "dependentRequired",
                   instance_types=("object",),
                   ),
    )
    ...
    Catalogue.create_vocabulary(
        ...
        KeywordDef(ContentSchemaKeyword, "contentSchema",
